...
MCMS.get_page_content = function (field) {
  ...
  if(MCMS.Router) {
    ...
    if(page && page[language][field]) {
      
      return page[language][field];
    }
...
MCMS.collections.PageLists = MCMS.Collection('pagelists');
MCMS.collections.PageListItems = MCMS.Collection('pagelistitems');
